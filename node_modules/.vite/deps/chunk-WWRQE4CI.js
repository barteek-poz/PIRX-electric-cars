...
var ObjectUtils = function() {
  ...
  _createClass(ObjectUtils2, null, [{
    ...
    value: function sort(value1, value2) {
      ...
      var locale2 = arguments.length > 3 ? arguments[3] : void 0;
      var nullSortOrder = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 1;
      var result = ObjectUtils2.compare(value1, value2, locale2, order);
    ...
    key: "compare",
    value: function compare(value1, value2, locale2) {
      ...
      if (emptyValue1 && emptyValue2)
        ...
        result = value1.localeCompare(value2, locale2, {
          numeric: true
        });
      else
...
var FilterService = {
  filter: function filter(value2, fields, filterValue, filterMatchMode, filterLocale) {
    ...
    var _iterator = _createForOfIteratorHelper2(value2), _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
  ...
  filters: {
    ...
    equals: function equals(value2, filter2, filterLocale) {
      ...
      if (value2.getTime && filter2.getTime)
        return value2.getTime() === filter2.getTime();
      else
        return ObjectUtils.removeAccents(value2.toString()).toLocaleLowerCase(filterLocale) === ObjectUtils.removeAccents(filter2.toString()).toLocaleLowerCase(filterLocale);
    },
    ...
    between: function between(value2, filter2) {
      ...
      if (value2.getTime)
        return filter2[0].getTime() <= value2.getTime() && value2.getTime() <= filter2[1].getTime();
      else
        return filter2[0] <= value2 && value2 <= filter2[1];
    },
...
function updateLocaleOption(key, value2, locale2) {
  localeOptions(locale2)[key] = value2;
}
...
var PrimeReactProvider = function PrimeReactProvider2(props) {
  var _useState = (0, import_react.useState)(false), _useState2 = _slicedToArray2(_useState, 2), ripple = _useState2[0], setRipple = _useState2[1];
  var _useState3 = (0, import_react.useState)("outlined"), _useState4 = _slicedToArray2(_useState3, 2), inputStyle = _useState4[0], setInputStyle = _useState4[1];
  var _useState5 = (0, import_react.useState)("en"), _useState6 = _slicedToArray2(_useState5, 2), locale2 = _useState6[0], setLocale = _useState6[1];
  var _useState7 = (0, import_react.useState)(null), _useState8 = _slicedToArray2(_useState7, 2), appendTo = _useState8[0], setAppendTo = _useState8[1];
  var _useState9 = (0, import_react.useState)(true), _useState10 = _slicedToArray2(_useState9, 2), cssTransition = _useState10[0], setCssTransition = _useState10[1];
  var _useState11 = (0, import_react.useState)(true), _useState12 = _slicedToArray2(_useState11, 2), autoZIndex = _useState12[0], setAutoZIndex = _useState12[1];
  var _useState13 = (0, import_react.useState)(false), _useState14 = _slicedToArray2(_useState13, 2), hideOverlaysOnDocumentScrolling = _useState14[0], setHideOverlaysOnDocumentScrolling = _useState14[1];
  var _useState15 = (0, import_react.useState)(null), _useState16 = _slicedToArray2(_useState15, 2), nonce = _useState16[0], setNonce = _useState16[1];
  var _useState17 = (0, import_react.useState)(1), _useState18 = _slicedToArray2(_useState17, 2), nullSortOrder = _useState18[0], setNullSortOrder = _useState18[1];
  ...
  var _useState21 = (0, import_react.useState)(void 0), _useState22 = _slicedToArray2(_useState21, 2), pt = _useState22[0], setPt = _useState22[1];
  var _useState23 = (0, import_react.useState)({
    text: [FilterMatchMode.STARTS_WITH, FilterMatchMode.CONTAINS, FilterMatchMode.NOT_CONTAINS, FilterMatchMode.ENDS_WITH, FilterMatchMode.EQUALS, FilterMatchMode.NOT_EQUALS],
    numeric: [FilterMatchMode.EQUALS, FilterMatchMode.NOT_EQUALS, FilterMatchMode.LESS_THAN, FilterMatchMode.LESS_THAN_OR_EQUAL_TO, FilterMatchMode.GREATER_THAN, FilterMatchMode.GREATER_THAN_OR_EQUAL_TO],
    date: [FilterMatchMode.DATE_IS, FilterMatchMode.DATE_IS_NOT, FilterMatchMode.DATE_BEFORE, FilterMatchMode.DATE_AFTER]
  }), _useState24 = _slicedToArray2(_useState23, 2), filterMatchModeOptions = _useState24[0], setFilterMatchModeOptions = _useState24[1];
...
//# sourceMappingURL=chunk-WWRQE4CI.js.map
